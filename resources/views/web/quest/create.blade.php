@extends('layouts.app')
@section('content')
<div class="container create_quest_page">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Create Quest</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/quest') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea id="description" class="form-control" noresize maxlength="3000" rows="14" spellcheck="false" name="description">{{ old('description') }}</textarea>
