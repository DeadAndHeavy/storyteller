        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('store_quest_variable', ['questId' => $questId ]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('default_value') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="default_value" class="form-control" maxlength="100" spellcheck="false" name="default_value" value="{{ old('default_value') }}">
                        ...
                        <div class="form-group{{ $errors->has('track_state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="track_state" id="track_state_yes" value="1">
                                        Yes
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="track_state" id="track_state_no" value="0" checked>
                                        No
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-2">
                                <a href="{{ route('quest_page', ['id' => $questId]) }}" class="btn btn-default">
                                    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Back quest page
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Create variable
                                </button>
                            </div>
                        </div>
                    </form>
